*>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>*
*.*.*.*.*.*.* Routine de restauration du décor sous les VBOBs *.*.*.*.*.*.*
*>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>.<>*
* Entrée	=> a5.l	Adr. 't'
*		=> a6.l	CUSTOM
vbob32_restore:
...
.wait_bimmer	btst	d3,(a1)
		...
		* ECRAN 1 *
		...
		lea	(vbob32_listes16-t,a5),a0
		bsr.s	.restore
		lea	(vbob32_listes32-t,a5),a0
		bsr.s	.restore
		lea	(vbob32_listes48-t,a5),a0
		bsr.s	.restore
		lea	(vbob32_listes64-t,a5),a0
		bsr.s	.restore
		lea	(vbob32_listes80-t,a5),a0
		bsr.s	.restore
		lea	(vbob32_listes96-t,a5),a0
		bra.s	.restore
		
		* ECRAN 2 *
.ecran2		lea	(vbob32_listes16+4-t,a5),a0
		bsr.s	.restore
		lea	(vbob32_listes32+4-t,a5),a0
		bsr.s	.restore
		lea	(vbob32_listes48+4-t,a5),a0
		bsr.s	.restore
		lea	(vbob32_listes64+4-t,a5),a0
		bsr.s	.restore
		lea	(vbob32_listes80+4-t,a5),a0
		bsr.s	.restore
		lea	(vbob32_listes96+4-t,a5),a0
