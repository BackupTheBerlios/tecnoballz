...
*xoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxox*
		...
		INCDIR	DH0:Data/
*>»=«<->»=«<->»=«<->»=«<->»=«<->»=«<->»=«<->»=«<->»=«<->»=«<->»=«<->»=«<->*
		INCDIR	DH1:Data/TecnoballZ/Include
...
*++++++++++++++++++* NOMBREUSES SOMMES D'ARGENT RECUES *++++++++++++++++++*
  / Jean-Pierre DEROURE / L'Argillière / Route de Neubourg 	  /
 / 27370 St NICOLAS DU BOSC					 /
/ Tél. : 32.35.18.12	=> 150FF le 28.09.95			/	
   / Gréderic Beaumord / 6 rue Collenot / 91220 Brétigny / Orge    /
  / Tél (1) 60.84.78.89 => 50FF Le 20.10.95                       /
TOTAL	: 200FF
*----------------------------* IDEES FUTURES *----------------------------*
* Inclure Tronic (jeu à part) ???
* Routine affichage au 68020 pour avec mémoire FAST ?
* Inclure musiques TECHNO-TRANCE
*									  *
****************************< TAILLE DES GFX >*****************************
