...
ssha_restore:
		...
		add.l	(ecran_shadow-t,a5),d4
		add.l	(ecran_shadow-t,a5),d5
...
.wait_bimmer	btst	#14,(a1)
		...
		* ECRAN 2 *
.ecran2		lea	(ssha_listes16+4-t,a5),a0
		bsr.s	.restore
...
*		=> a0.l	pointeur sur la liste de restauration ssha
*		=> a1.l	DMACONR
*		=> a2.l	BLTAPTH
*		=> a3.l	BLTDPTH
*		=> a4.l	BLTSIZE
...
.wf_loop	move.l	(a0)+,d3		d3=nbre de sshas - 1
		bmi.s	.stop			-> pas de sshas à effacer
.loop		move.l	(a0)+,d0		d0=adr. relative du ssha
		move.l	d0,d1
...
.waitblitter	btst	#14,(a1)
		...
		move.l	(a0),d0			d0=2ieme adr. relative du ssha
		move.l	d0,d1
