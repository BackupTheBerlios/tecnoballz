...
controller_ejectors::initialise ()
{
  ...
  eject2PosY =
    (EJECT_POS1 * resolution) - ejector_02->get_sprite_height () / 2;
  ...
  eject3PosY =
    (EJECT_POS2 * resolution) - ejector_03->get_sprite_height () / 2;
  ...
  eject4PosY =
    (EJECT_POS2 * resolution) - ejector_04->get_sprite_height () / 2;
...
//-----------------------------------------------------------------------------
void
controller_ejectors::afficheSha ()
{
  if (bob_ground)
    return;
...
//-----------------------------------------------------------------------------
void
controller_ejectors::afficheGfx ()
{
  if (bob_ground)
    return;
...
//-----------------------------------------------------------------------------
sprite_object *
controller_ejectors::demandeBOB (Sint32 eject)
{
  switch (eject)
    {
    case 1:
