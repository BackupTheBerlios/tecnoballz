 ...
 * $Id: sprite_money.cc,v 1.5 2007/02/11 10:37:50 gurumeditation Exp $
 *
...
//-----------------------------------------------------------------------------
void
sprite_money::init_money (Uint32 xcoord, Uint32 ycoord, sprite_paddle * raket)
{
  is_enabled = 1;
  x_coord = xcoord;
  y_coord = ycoord;
  ...
  if (!is_enabled)
    {
      ...
      Sint32 i = speed_of_moving;
      sprite_paddle *raket = paddle;
      switch (directionX)
        {
