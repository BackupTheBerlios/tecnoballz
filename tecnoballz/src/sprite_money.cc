 ...
 * $Id: sprite_money.cc,v 1.6 2007/02/11 16:04:44 gurumeditation Exp $
 *
...
bool sprite_money::enable_if_available (brickClear * brick)
{
  ...
  init_money (brick->balle_posX, brick->balle_posY, brick->raquettePT);
  return true;
}
...
bool sprite_money::enable_if_available (sprite_ball * ball)
{
  ...
  init_money (ball->x_coord, ball->y_coord, ball->raket_ball);
  return true;
}
