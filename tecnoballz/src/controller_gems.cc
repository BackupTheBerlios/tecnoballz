...
//
//-----------------------------------------------------------------------------
Sint32	controller_gems::initialise(handler_players* pjda, barreScore *score, printmoney *money,
...
//-----------------------------------------------------------------------------
void controller_gems::sendNewGem(sprite_ball *pball)
{
	for(Uint32 i = 0; i < max_of_sprites; i++)
	{	sprite_gem *ptGem = sprites_list[i];
...
// bricks levels: send a gem
//-----------------------------------------------------------------------------
void controller_gems::sendNewGem(sprite_projectile *pfire)
{
	for(Uint32 i = 0; i < max_of_sprites; i++)
	{	sprite_gem *ptGem = sprites_list[i];
...
//-----------------------------------------------------------------------------
void controller_gems::moving_gem()
{
	for(Uint32 i = 0; i < max_of_sprites; i++)
	{	sprite_gem *ptGem = sprites_list[i];
