...
//-----------------------------------------------------------------------------
const amigaLevel* level_data::bricklevel(Uint32 area, Uint32 lvnu)
{
	if (area < 1 || area > 5)
	{	fprintf(stderr,
...
//-----------------------------------------------------------------------------
const atariLevel* level_data::guardlevel(Uint32 area, Uint32 lvnu)
{	
	if (area < 1 || area > 5)
	{	fprintf(stderr,
			"(!) level_data::bricklevel() : area %i out of range\n",
...
// :-) :-) :-) :-) :-) :-) :-) :-) :-) :-)   (-: (-: (-: (-: (-: (-: (-: (-: (-:   
// Table des gardiens
const Sint16 level_data::zeCourseXX[] =
...
// Area 1 : level 1
const Sint16 level_data::zeCourse10[] =
...
const Sint16 level_data::zeCourse11[] =
...
const Sint16 level_data::zeCourse12[] =
...
// Area 2 
const Sint16 level_data::zeCourse20[] =
...
// Area 3
const Sint16 level_data::zeCourse30[] =
...
// Aera 4
const Sint16 level_data::zeCourse40[] =
...
const Sint16 level_data::zeCourse50[] =
...
const Sint16 level_data::zeCourse55[] =
...
// AREA 1 : level 1
const amigaLevel level_data::amigaTab10 =
{	0,			// 0 = bricks level
...
// AREA 1 : level 2 to 5
const amigaLevel level_data::amigaTab11 =
{ 0,
  1 * 50,
  45 * 50,
  25 * 50,
...
const amigaLevel level_data::amigaTab12 =
{ 0,
  1 * 50,
  35 * 50,
  25 * 50,
...
// AREA 2
const amigaLevel level_data::amigaTab20 =
{ 0,
  1 * 50,
  40 * 50,
  30 * 50,
...
// AREA 3
const amigaLevel level_data::amigaTab30 =
{ 0,
  1 * 50,
  30 * 50,
  20 * 50,
...
// AREA 4
const amigaLevel level_data::amigaTab40 =
{ 0,
  1 * 50,
  21 * 50,
  14 * 50,
...
// AREA 5 : level 1 to 5
const amigaLevel level_data::amigaTab50 =
{ 0,
  1 * 50,
  15 * 50,
  10 * 50,
...
const amigaLevel level_data::amigaTab55 =
{ 0,
  1 * 50,
  4 * 50,
  3 * 50,
...
//#######################################################################
// area 1 : level 6
const atariLevel level_data::atariTab00 =
{ 1,			// 1 = guards levels
  3,			// speed ball
...
// Area  1 : Level 12
const atariLevel level_data::atariTab04 =
{ 1,			
  3,
  50 * 115,
  10 * 50,
...
// Area 2 : Level 6
const atariLevel level_data::atariTab08 =
{ 1,
  4,
  50 * 10,
  10 * 50,
...
// Area 2 : Level 12
const atariLevel level_data::atariTab12 =
{ 1,
  4,
  50 * 10,
  10 * 50,
...
// Area 3 : Level 6
const atariLevel level_data::atariTab16 =
{ 1,
  4,
  50 * 10,
  10 * 50,
...
// Area 3 : Level 12
const atariLevel level_data::atariTab20 =
{ 1,
  4,
  50 * 10,
  10 * 50,
...
// Area 4 : Level 6
const atariLevel level_data::atariTab24 =
{ 1,
  4,
  50 * 10,
  10 * 50,
...
// Area 4 : Level 12
const atariLevel level_data::atariTab28 =
{ 1,
  4,
  50 * 10,
  10 * 50,
...
// Area 5 : Level 6
const atariLevel level_data::atariTab32 =
{ 1,
  4,
  50 * 10,
  10 * 50,
...
// Area 5 : Level 12
const atariLevel level_data::atariTab36 =
{ 1,
  4,
  50 * 10,
  10 * 50,
...
// Area 5 : Level 13
const atariLevel level_data::atariTab40 =
{ 1,
  4,
  50 * 10,
  10 * 50,
